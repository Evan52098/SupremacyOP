...
@CommandPermissions(level = AdminLevel.SUPER, source = SourceType.CONSOLE_ONLY)
@CommandParameters(description = "Senior Command, Runs the cleanup system - Use this command at your own risk!!", usage = "/<command>")
